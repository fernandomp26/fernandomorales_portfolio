    ...
    return (
        <div className="contactme-container" ref={contactRef}>
            ...
            <div className="contactme-content">
                <p>If you liked my portfolio, or my projects, you can visit my <b>GitHub</b> to see more about them and some codes. And if you want to contact me, you can click on the icons at the top of the page (<b>Whatsapp/Instagram</b>) and sand me a message!</p>
